...
root.resizable(0,0)
root.title("Translator by Viswanadha Varma")
root.config(bg = 'yellow')


Label(root, text = "LANGUAGE TRANSLATOR", font = "arial 20 bold", bg='pale green').pack()
Label(root,text ="Translator", font = 'arial 20 bold', bg ='pale green' , width = '20').pack(side = 'bottom')
